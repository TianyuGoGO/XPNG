...
class XTransformer(BasicModel):
    def __init__(self):
        ...
        # att_feats encoder
        sequential = []
        sequential.append(nn.Linear(256,256))
        sequential.append(utils.activation("CELU"))
     
        sequential.append(nn.LayerNorm(256))
        
        sequential.append(nn.Dropout(0.5))    
    ...
    def forward(self, att_feats,att_mask):
