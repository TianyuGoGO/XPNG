...
class PanopticNarrativeGroundingDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return caption, grounding_instances, \
            ann_categories, ann_types, noun_vector_padding, ret_noun_vector, fpn_data,attn_mask,attn_mask1
...
class PanopticNarrativeGroundingValDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return caption, grounding_instances, \
            ann_categories, ann_types_valid, noun_vector_padding, ret_noun_vector, fpn_data, ann_types,attn_mask,attn_mask1
