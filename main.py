...
def parse_args():
    ...
    parser.add_argument(
        '--detectron2_ckpt', 
        default='/media/sdb4/jijiayi/guotianyu/PPMN_yoso/pretrained_models/fpn/model_final_cafdb1.pkl', 
        type=str, 
    ...
    parser.add_argument(
        '--pretrained_bert',
        default='/media/sdb4/jijiayi/guotianyu/PPMN_yoso/pretrained_models/bert/bert-base-uncased/',
        type=str,
        help='Pretrained bert model.'
    )
    parser.add_argument(
        '--bert_tokenize',
        default='/media/sdb4/jijiayi/guotianyu/PPMN_yoso/pretrained_models/bert/bert-base-uncased.txt',
        type=str,
    ...
    parser.add_argument(
        '--data_path',
        default='/media/sdb4/jijiayi/guotianyu/PPMN_yoso/panoptic_narrative_grounding', 
        type=str,
    ...
    parser.add_argument(
        '--output_dir', 
        default="/media/sdb4/jijiayi/guotianyu/PPMN_yoso_imgfeature_updated/random_center/", 
        type=str, 
        help='Saving dir.'
       # /media/sdb4/jijiayi/guotianyu/PPMN_yoso_imgfeature_updated/train_log/
    )
    parser.add_argument(
        '--test_only',
        action='store_true',
